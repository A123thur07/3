...
export default function App() {
  ...
  const novaRodada = async () => {
    try {
      ...
      const resposta = await fetch('https://jogopaises-delta.vercel.app/jogo')
  ...
  return (
    <View style={styles.container}>
      <Text>Qual o país dessa bandeira?</Text>
      ...
      {
        mensagem !== "" && (
          <View style={[styles.cardFeedback, mensagem === "Você acertou!" ? styles.bgAcertou : styles.bgErrou]}>
