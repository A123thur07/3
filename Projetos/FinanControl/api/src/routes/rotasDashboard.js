...
//Rota unica para o meu dashboard
router.get('/dashboard', autenticarToken, async (req, res) =>{
    try{
       ...
       `
        ...
        const resGastosCategoria = await BD.query(gastosCategorias);
